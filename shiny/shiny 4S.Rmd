...
```{r}
selectInput(inputId = "x", label = "Pick an independent variable (X)", choices = names(iris)[sapply(iris, is.numeric)], selected = "Petal.Length")
```

---

```{r}
selectInput(inputId = "y", label = "Pick a dependent variable (Y)", choices = names(iris)[sapply(iris, is.numeric)], selected = "Petal.Width")
```
