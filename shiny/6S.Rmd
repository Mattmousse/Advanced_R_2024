...
require(DT)
options(shiny.maxRequestSize = 300*1024^2)  # Set the maximum request size to 30MB
options(shiny.maxFilesize = 300*1024^2)   # Set the maximum file size to 30MB
```
...
df <- reactive({
  if (is.null(input$csvFile)) {
    ...
    read.csv(input$csvFile$datapath, nrows = 1000)
  }
})
```
